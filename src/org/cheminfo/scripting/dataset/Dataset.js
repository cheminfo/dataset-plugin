...
var Dataset = (function () {
     ...
     *
     **/
    Dataset.show = function (path, exportName, options) {
     ...
     * @return    +Dataset
     **/
    Dataset.loadData = function (source, options) {
        ...
        if (options.metadata != undefined) {
            var uniqueColumnName = options.uniqueColumnName || 'name';
            var metanameFilter = options.metanameFilter || function (value) {
                    return value;
                };
        ...
        var metanameMatch = options.metanameMatch || function (name, metaname) {
    ...
    function DataCollection(data, source) {
        this.data = data;
        this.source = source;
        this.batches = false;
        this.getBatches();
     ...
     *
     **/
    DataCollection.prototype.toVisualizer = function (exportName) {
     ...
     *
     */
    DataCollection.prototype.imageSplitTest = function (version, imageFilter, options) {
     ...
     **/
    DataCollection.prototype.removeSample = function (sample) {
        var samples = [];
     ...
     **/
    DataCollection.prototype.getSimilarityMatrix = function (version, similarityFunction, options) {
        ...
        if (typeof similarityFunction == 'string') {
            ...
            comparator = {
                compare: similarityFunction, getMap: function (a) {
                    return a;
                }
     ...
     * @return    +Matrix
     **/
    DataCollection.prototype.getTargetMatrix = function (options) {
     ...
     *
     **/
    DataCollection.prototype.getDataType = function (version) {
     ...
     **/
    DataCollection.prototype.save = function (filename) {
        File.saveJSON(this.source + '/_json/' + filename + '.json', JSON.stringify({
            data: this.data,
            source: this.source
        }));
    };
    ...
    DataCollection.prototype.pca2 = function (version, options) {
        options = options ? options : {};
        options.pca2 = true;
     ...
     * @return    +Object
     **/
    DataCollection.prototype.cluster = function (version, distanceFunction, options) {
    ...
    DataCollection.prototype.getDescriptors = function () {
    ...
    function processImage(method, parameters) {
        ...
        var saveEntry = function (data, image, newPath, newVersion) {
            ...
            image.save(newPath);
            data[i]['data'][newVersion] = {
                filename: newPath,
                viewFile: Visualizer.getTypedURL(newPath),
